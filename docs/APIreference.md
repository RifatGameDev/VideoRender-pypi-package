...
??? note "example"
    ### Short example
    ```python
    from VideoRender import render_YouTube_video
    URL = "https://youtu.be/2YTEueEGMLg?si=oHJ2Qi-AMApXjDZj"
...
??? note "example"
    ### Short example
    ```python
    from VideoRender import render_site
    URL = "https://pypi.org/project/VideoRender/"
